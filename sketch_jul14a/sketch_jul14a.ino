...
void speed1 ()
{
  ...
  if( (digitalRead(ir1) == HIGH) && (digitalRead(ir2) == HIGH) && (state == 1))
    { 
      lcd.clear();
          lcd.setCursor(0, 0);
          lcd.print("SPEED: ");lcd.print(state);lcd.print(" MIN");
...
void speed2 ()
{
  ...
  if( (digitalRead(ir1) == HIGH) && (digitalRead(ir2) == HIGH) && (state == 2))
    { 
      lcd.clear();
          lcd.setCursor(0, 0);
          lcd.print("SPEED: ");lcd.print(state);lcd.print(" MID");
          lcd.setCursor(0, 1);
          lcd.print("COUNT: ");lcd.print(count);
      analogWrite(pwm, 220);
     while( digitalRead(ir3) ==LOW); 
...
void speed3 ()
{
  ...
  if( (digitalRead(ir1) == HIGH) && (digitalRead(ir2 )== HIGH )&& (state == 3))
    { 
      lcd.clear();
          lcd.setCursor(0, 0);
