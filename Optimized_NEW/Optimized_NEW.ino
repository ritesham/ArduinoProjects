...
int pwm =     3;               // assigns pin 10 to variable pwm
int inPin1 =  5;                // assigns pin 6 to pushbutton 1
int inPin2 =  6;                // assigns pin 7 to pushbutton 2
int ir1 =     7;                // assigns pin 8 to IR Sensor Front 1
int ir2 =     8;                // assigns pin 9 to IR Sensor Front 2
...
long debounceDelay = 40;    // the debounce time; increase if the output is still sensitive
